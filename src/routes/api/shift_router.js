...
router.get('/:current_event_id/ShiftsByUser/user_id/:user_id', checkRole, permissionMiddleware.checkCurrentUserOrAdmin, shiftController.getShiftsByUserAndEvent);
